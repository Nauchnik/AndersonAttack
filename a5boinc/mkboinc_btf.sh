...
nvcc -c kernel.cu -O3 -D_FORCE_INLINES -gencode arch=compute_20,code=sm_20  -gencode arch=compute_50,code=sm_50 --ptxas-options="-v -dlcm=cg" -I/usr/local/cuda/samples/common/inc -o kernel.o
g++ -c ./boinc_a5_btf.cpp -o boinc_a5_btf.o  -I/usr/local/include/boinc/ 
